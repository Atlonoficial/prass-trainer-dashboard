-- WORKOUT SYSTEM 2.0 - Data Migration and Cleanup (Fixed)
...
-- Step 6: Add workout_plans to realtime publication if not already added
DO $$
BEGIN
    IF NOT EXISTS (
