...
drop policy if exists "Teachers can insert invitations" on public.student_invitations;
create policy "Teachers can insert invitations" on public.student_invitations
for insert to authenticated
with check (auth.uid() = teacher_id);

drop policy if exists "Teachers can update invitations" on public.student_invitations;
create policy "Teachers can update invitations" on public.student_invitations
for update to authenticated
using (auth.uid() = teacher_id);

drop policy if exists "Teachers can view invitations" on public.student_invitations;
create policy "Teachers can view invitations" on public.student_invitations
