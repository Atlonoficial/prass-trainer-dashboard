-- Corrigir função de presença e contadores de mensagens não lidas
...
-- Função para padronizar IDs de conversas (usar hífen em vez de underscore)
UPDATE public.conversations 
SET id = REPLACE(id, '_', '-')
WHERE id LIKE '%_%';

-- Atualizar mensagens para usar os novos IDs padronizados
