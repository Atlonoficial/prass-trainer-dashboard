-- Corrigir função safe_delete_workout com melhor autenticação e logging
...
-- Corrigir função safe_delete_nutrition_plan também
...
-- Revisar política RLS para workouts DELETE
...
-- Revisar política RLS para nutrition_plans DELETE  
