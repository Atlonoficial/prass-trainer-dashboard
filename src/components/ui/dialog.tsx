...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-4 top-4 sm:right-6 sm:top-6 rounded-md bg-background/80 backdrop-blur-sm border border-border/40 opacity-90 hover:opacity-100 hover:bg-background hover:border-border transition-all focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none z-[100] h-8 w-8 flex items-center justify-center">
        <X className="h-4 w-4" />
