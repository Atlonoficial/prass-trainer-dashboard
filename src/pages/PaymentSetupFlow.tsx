...
export default function PaymentSetupFlow() {
        ...
        <CardContent className="space-y-6">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-2 text-sm text-muted-foreground">
              ...
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-success mt-0.5 flex-shrink-0" />
                <span>Pagamentos processados automaticamente</span>
              </li>
              <li className="flex items-start gap-2">
                <CheckCircle className="h-4 w-4 text-success mt-0.5 flex-shrink-0" />
                <span>Notificações de pagamentos em tempo real</span>
              </li>
            </ul>
          </div>
          ...
          <Alert>
            <AlertDescription className="text-sm">
              <strong>💡 Dica:</strong> O administrador gerencia o sistema de pagamentos 
              centralmente. Você não precisa configurar credenciais individuais.
            </AlertDescription>
          </Alert>
        </CardContent>
      </Card>
